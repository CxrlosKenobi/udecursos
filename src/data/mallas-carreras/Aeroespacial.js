...
const Aeroespacial = {
  ...
  Tasks: {
    ...
    'task-2': { id: 'task-2', content: 'Álgebra I', color: "black", credits: "5", code: "525140", prerequisites: [] },
    'task-3': { id: 'task-3', content: 'Cálculo I', color: "black", credits: "5", code: "527140", prerequisites: [] },
    'task-4': { id: 'task-4', content: 'Química General I', color: "black", credits: "5", code: "531140", prerequisites: [] },
    'task-5': { id: 'task-5', content: 'Intro. Ingeniería Aeroespacial', color: "black", credits: "2", code: "541130-0", prerequisites: [] },

    'task-6': { id: 'task-6', content: 'Física II', color: "black", credits: "4", code: "510150", prerequisites: [] },
    'task-7': { id: 'task-7', content: 'Álgebra II', color: "black", credits: "5", code: "525150", prerequisites: [] },
    'task-8': { id: 'task-8', content: 'Cálculo II', color: "black", credits: "5", code: "527150", prerequisites: [] },
    'task-9': { id: 'task-9', content: 'Química General II', color: "black", credits: "5", code: "531150", prerequisites: [] },
    'task-10': { id: 'task-10', content: 'Intro. Innovación Ingeniería', color: "black", credits: "2", code: "500151", prerequisites: [] },

    'task-11': { id: 'task-11', content: 'Ecuaciones Diferenciales', color: "black", credits: "4", code: "525223", prerequisites: [] },
    'task-12': { id: 'task-12', content: 'Mediciones', color: "black", credits: "2", code: "541226", prerequisites: [] },
    'task-13': { id: 'task-13', content: 'Cálculo III', color: "black", credits: "5", code: "521227", prerequisites: [] },
    'task-14': { id: 'task-14', content: 'Estática', color: "black", credits: "5", code: "541227", prerequisites: [] },
    'task-15': { id: 'task-15', content: 'Programación', color: "black", credits: "3", code: "503203", prerequisites: [] },
    'task-16': { id: 'task-16', content: 'Comunicación Gráfica', color: "black", credits: "2", code: "541228", prerequisites: [] },

    'task-17': { id: 'task-17', content: 'Cálculo Numérico', color: "black", credits: "4", code: "521230", prerequisites: [] },
