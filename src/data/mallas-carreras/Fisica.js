...
const Fisica = {
  ...
  Tasks: {
    ...
    'task-24': { id: 'task-24', content: 'Mecánica Clásica II', color: "black", credits: "0", code: "000000-0", prerequisites: [] },
    ...
    'task-28': { id: 'task-28', content: 'Electrodinámica II', color: "black", credits: "0", code: "000000-0", prerequisites: [] },
    ...
    'task-32': { id: 'task-32', content: 'Mecánica Cuántica II', color: "black", credits: "0", code: "000000-0", prerequisites: [] },
    'task-33': { id: 'task-33', content: 'Física Estado Sólido', color: "black", credits: "0", code: "000000-0", prerequisites: [] },
    'task-34': { id: 'task-34', content: 'Laboratorio III', color: "black", credits: "0", code: "000000-0", prerequisites: [] },
    ...
    'task-40': { id: 'task-40', content: 'Laboratorio IV', color: "black", credits: "0", code: "000000-0", prerequisites: [] },

    'task-41': { id: 'task-41', content: 'Física Estadística II', color: "black", credits: "0", code: "000000-0", prerequisites: [] },
